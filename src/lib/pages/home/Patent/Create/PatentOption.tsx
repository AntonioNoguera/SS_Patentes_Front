...
const PatentOption: React.FC<PatentOptionProps> = ({
  ...
  return (
    <div
      className="flex flex-col rounded-3xl items-center w-full mx-10 justify-between h-full   bg-PtahBg hover:shadow-xl hover:bg-gray-200 p-8 cursor-pointer transition-all"
